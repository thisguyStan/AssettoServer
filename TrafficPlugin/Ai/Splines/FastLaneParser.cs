...
using TrafficPlugin.Ai.Configuration;
...
public class FastLaneParser
{
    ...
    public FastLaneParser(ACServerConfiguration configuration, AiParams aiParams)
    {
    ...
    public MutableAiSpline FromFiles(string folder)
    {
        ...
        return new MutableAiSpline(splines, _aiParams.LaneWidthMeters, _aiParams.TwoWayTraffic, configuration, _logger);
    }
